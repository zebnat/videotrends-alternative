   ...
   <div className="formOpts">
    ...
    <div className="selectBlock">
     ...
     <select onChange={selectChanged} value={country}>
      ...
      <option value="de-de">Deutschland (Germany)</option>
      <option value="it-it">Italia (Italy)</option>
      <option value="nl-nl">Nederland (Netherlands)</option>
      <option value="zh-hk">香港粵語 (Hong Kong)</option>
      <option value="ja-jp">日本 (Japan)</option>
      <option value="ko-kr">대한민국 (S.Korea)</option>
